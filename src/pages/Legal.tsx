      ...
      <section className="relative text-white py-10 lg:py-10">
        <div className="container mx-auto px-4 relative z-20">
          ...
          >
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-gray-900">{t('legal.hero.title')}</h1>
            <p className="text-lg lg:text-xl text-gray-900">{t('legal.hero.subtitle')}</p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="border-t border-gray-200 pt-4">
                <h3 className="font-semibold text-gray-900 mb-2">{t('legal.information.intellectualProperty.title')}</h3>
              ...
              <div className="border-t border-gray-200 pt-4">
                <h3 className="font-semibold text-gray-900 mb-2">{t('legal.information.hosting.title')}</h3>
                <p className="text-gray-600 text-sm">
